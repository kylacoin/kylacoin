...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Повідомлення, що було додане до kylacoin:URI та буде збережено разом з транзакцією для довідки. Примітка: це повідомлення не буде відправлено в мережу Біткоїн.</translation>
    </message>
</context>
<context>
