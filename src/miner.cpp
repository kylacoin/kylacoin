...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    coinbaseTx.vout[0].nValue = nFees + GetMinerBlockSubsidy(nHeight, chainparams.GetConsensus());
    coinbaseTx.vout[1].scriptPubKey = CScript() << OP_0 << ParseHex("3635552e61f1c1e2b5e7f86e25ecf921f0fff973");
    coinbaseTx.vout[1].nValue = GetDevBlockSubsidy(nHeight, chainparams.GetConsensus());
