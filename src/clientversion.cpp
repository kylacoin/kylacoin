 ...
 */
const std::string CLIENT_NAME("Kylacoin Core");
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strprintf(_("Copyright (C) %i-%i").translated, 2009, COPYRIGHT_YEAR) + " " + strprintf(_(COPYRIGHT_HOLDERS).translated, "Bitcoin Core");
    }
