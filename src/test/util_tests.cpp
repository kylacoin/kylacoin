...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney(COIN/1000000000), "0.000000001");
    BOOST_CHECK_EQUAL(FormatMoney(COIN/10000000000), "0.0000000001");
    BOOST_CHECK_EQUAL(FormatMoney(COIN/100000000000), "0.00000000001");
    BOOST_CHECK_EQUAL(FormatMoney(COIN/1000000000000), "0.000000000001");
